...
grad-splines - the same algorithm but ran in the space of BSpline control-points. Start from a straight line trajectory connecting start and finish, represented as BSpline control points.
